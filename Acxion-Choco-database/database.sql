...
-- -----------------------------------------------------
-- TABLE `ACXIONCHOCODATABASE`.`USER_AUTHENTICATION`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ACXIONCHOCODATABASE`.`USER_AUTHENTICATION` (
  `IDUSER` VARCHAR(13) NOT NULL,
  `FK_IDDOCTYPE` VARCHAR(3) NOT NULL,
  ...
  CONSTRAINT `FK_USER_AUTHENTICATION_USER`
    FOREIGN KEY (`IDUSER`)
    REFERENCES `ACXIONCHOCODATABASE`.`USER` (`IDUSER`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
ENGINE = INNODB
